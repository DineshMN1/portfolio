...
<details className="mb-4">
  ...
  <ul className="list-disc pl-6 mt-2 text-gray-500 dark:text-gray-400 text-[15px] space-y-1">
    ...
    <li><a href="#consensus-mechanisms" className="hover:text-blue-500">Consensus Mechanisms</a></li>
...
<h2 id="consensus-mechanisms" className="text-xl font-semibold mt-8 mb-2">Consensus Mechanisms</h2>
